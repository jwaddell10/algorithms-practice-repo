...
being a zigzag. More formally, your task is to construct an array of length numbers.length - 2, where the 
ith element of the output array equals 1 if the triple (numbers[i], numbers[i + 1], numbers[i + 2]) is a zigzag, and 0 otherwise.
...
console.log(zigZag([1, 2, 1, 3, 4])) // [1, 1, 0]
console.log(zigZag([1, 2, 1, 3, 4, 3])) // [1, 1, 0, 1]
console.log(zigZag([1, 4, 2, 3, 4, 3, 4])) // [1, 1, 0, 1]
console.log(zigZag([1000000000, 1000000000, 1000000000])) // [0]